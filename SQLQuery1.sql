...
create table Owner(
	OwnerId CHAR(36) PRIMARY KEY NOT NULL,
...
create table Account(
	AccountId CHAR(36) PRIMARY KEY NOT NULL,
	DateCreated DATE NOT NULL,
	AccountType NVARCHAR(45) NOT NULL,
	OwnerId CHAR(36) NOT NULL REFERENCES Owner (OwnerId) ON DELETE NO ACTION ON UPDATE NO ACTION 
)
GO
...
INSERT INTO accountowner.dbo.Owner
...
INSERT INTO accountowner.dbo.account
